...
# ? Move to __main__.py? This is a bad use of __init__
...
def proceed_to_main_menu(game: Game):
    ...
    :param game: Game to display on main menu
    :return: None
    """
...
def is_version_compatible(save_version: str):
    """ Check that the given save version is compatible with the current version.

    :param save_version: Version to check compatibility for.
    :return: True if the save version is compatible with the current version, False otherwise.
    """
